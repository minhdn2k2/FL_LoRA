from clients.clientfedit import ClientFedIT
from servers.serverbase import BaseServer


class ServerFedIT(BaseServer):
    def __init__(self, args):
        super().__init__(args)

        self.setup_clients(args, ClientFedIT)
        print("Finished creating server and clients for FedIT.")
